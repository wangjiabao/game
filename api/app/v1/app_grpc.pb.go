...
const (
	...
	App_SkateGet_FullMethodName               = "/api.app.v1.App/SkateGet"
	App_SkateGetPlay_FullMethodName           = "/api.app.v1.App/SkateGetPlay"
...
type AppClient interface {
	...
	// 放大器质押解压
	SkateGet(ctx context.Context, in *SkateGetRequest, opts ...grpc.CallOption) (*SkateGetReply, error)
	// 放大器游戏
	SkateGetPlay(ctx context.Context, in *SkateGetPlayRequest, opts ...grpc.CallOption) (*SkateGetPlayReply, error)
	// 土地替换，收回
...
func (c *appClient) UserSkateRewardList(ctx context.Context, in *UserSkateRewardListRequest, opts ...grpc.CallOption) (*UserSkateRewardListReply, error) {
	...
	err := c.cc.Invoke(ctx, App_UserSkateRewardList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *appClient) SkateGet(ctx context.Context, in *SkateGetRequest, opts ...grpc.CallOption) (*SkateGetReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SkateGetReply)
	err := c.cc.Invoke(ctx, App_SkateGet_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *appClient) SkateGetPlay(ctx context.Context, in *SkateGetPlayRequest, opts ...grpc.CallOption) (*SkateGetPlayReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SkateGetPlayReply)
	err := c.cc.Invoke(ctx, App_SkateGetPlay_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAppServer) SkateGet(context.Context, *SkateGetRequest) (*SkateGetReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SkateGet not implemented")
}
func (UnimplementedAppServer) SkateGetPlay(context.Context, *SkateGetPlayRequest) (*SkateGetPlayReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SkateGetPlay not implemented")
}
...
func _App_SkateGet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SkateGetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AppServer).SkateGet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: App_SkateGet_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AppServer).SkateGet(ctx, req.(*SkateGetRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _App_SkateGetPlay_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SkateGetPlayRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AppServer).SkateGetPlay(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: App_SkateGetPlay_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AppServer).SkateGetPlay(ctx, req.(*SkateGetPlayRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var App_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SkateGet",
			Handler:    _App_SkateGet_Handler,
		},
		{
			MethodName: "SkateGetPlay",
			Handler:    _App_SkateGetPlay_Handler,
		},
		{
			MethodName: "LandPlay",
