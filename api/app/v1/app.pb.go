...
type UserRecommendLReply_List struct {
	...
	CreatedAt string  `protobuf:"bytes,3,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"` // 奖励时间
}
...
type UserStakeRewardListReply_List struct {
	...
	CreatedAt string  `protobuf:"bytes,3,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"` // 日期
}
...
type UserBackListReply_List struct {
	...
	UseNum uint64  `protobuf:"varint,3,opt,name=use_num,json=useNum,proto3" json:"use_num,omitempty"`  // 剩余使用次数
	Status uint64  `protobuf:"varint,4,opt,name=status,proto3" json:"status,omitempty"`                // 状态：默认1，2，出售中4，左上角显示对应的英文文案，在资源里找对应的图
	OutMax float64 `protobuf:"fixed64,6,opt,name=out_max,json=outMax,proto3" json:"out_max,omitempty"` // 如果是种子，需要展示的产出数量
}
...
var file_api_app_v1_app_proto_rawDesc = []byte{
	...
	0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xc3, 0x08, 0x0a, 0x0d, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e,
	...
	0x73, 0x65, 0x6c, 0x6c, 0x46, 0x65, 0x65, 0x52, 0x61, 0x74, 0x65, 0x22, 0x2a, 0x0a, 0x14, 0x55,
	...
	0x04, 0x52, 0x04, 0x70, 0x61, 0x67, 0x65, 0x22, 0xd2, 0x01, 0x0a, 0x12, 0x55, 0x73, 0x65, 0x72,
	...
	0x04, 0x6c, 0x69, 0x73, 0x74, 0x1a, 0x55, 0x0a, 0x04, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x18, 0x0a,
	0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07,
	0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x65, 0x76, 0x65, 0x6c,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x01, 0x52, 0x05, 0x6c, 0x65, 0x76, 0x65, 0x6c, 0x12, 0x1d, 0x0a,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x03, 0x6e, 0x75, 0x6d, 0x22, 0xd6, 0x01, 0x0a, 0x13,
	0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x64, 0x4c, 0x52, 0x65,
	...
	0x2e, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x1a, 0x57, 0x0a, 0x04, 0x4c,
	...
	0x65, 0x64, 0x41, 0x74, 0x22, 0x25, 0x0a, 0x0f, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x61, 0x6e, 0x64,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61, 0x67, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x04, 0x70, 0x61, 0x67, 0x65, 0x22, 0x88, 0x02, 0x0a, 0x0d,
	...
	0x94, 0x01, 0x0a, 0x04, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01,
	...
	0x65, 0x61, 0x6c, 0x74, 0x68, 0x18, 0x06, 0x20, 0x01, 0x28, 0x01, 0x52, 0x09, 0x70, 0x65, 0x72,
	0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x22, 0x30, 0x0a, 0x1a, 0x55, 0x73, 0x65, 0x72, 0x53, 0x74,
	...
	0x28, 0x04, 0x52, 0x04, 0x70, 0x61, 0x67, 0x65, 0x22, 0xc6, 0x01, 0x0a, 0x18, 0x55, 0x73, 0x65,
	...
	0x75, 0x6e, 0x74, 0x12, 0x3d, 0x0a, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x29, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x61, 0x70, 0x70, 0x2e, 0x76, 0x31, 0x2e, 0x55,
	...
	0x73, 0x74, 0x1a, 0x3d, 0x0a, 0x04, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x6d,
	...
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61, 0x67, 0x65, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x04, 0x70, 0x61, 0x67, 0x65, 0x22, 0xb8, 0x01, 0x0a, 0x10,
	...
	0x04, 0x6c, 0x69, 0x73, 0x74, 0x1a, 0x3f, 0x0a, 0x04, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x18, 0x0a,
	...
	0x65, 0x22, 0x82, 0x02, 0x0a, 0x11, 0x55, 0x73, 0x65, 0x72, 0x42, 0x61, 0x63, 0x6b, 0x4c, 0x69,
	...
	0x6d, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x03, 0x6e, 0x75, 0x6d, 0x12, 0x17, 0x0a, 0x07,
	0x75, 0x73, 0x65, 0x5f, 0x6e, 0x75, 0x6d, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x75,
	0x73, 0x65, 0x4e, 0x75, 0x6d, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x17, 0x0a,
	0x07, 0x6f, 0x75, 0x74, 0x5f, 0x6d, 0x61, 0x78, 0x18, 0x06, 0x20, 0x01, 0x28, 0x01, 0x52, 0x06,
	0x6f, 0x75, 0x74, 0x4d, 0x61, 0x78, 0x32, 0xba, 0x08, 0x0a, 0x03, 0x41, 0x70, 0x70, 0x12, 0x65,
	...
	0x64, 0x12, 0x93, 0x01, 0x0a, 0x13, 0x55, 0x73, 0x65, 0x72, 0x53, 0x74, 0x61, 0x6b, 0x65, 0x52,
	...
	0x2f, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x73, 0x74, 0x61, 0x6b, 0x65, 0x5f, 0x72, 0x65, 0x77, 0x61,
	0x72, 0x64, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x12, 0x72, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x42,
	...
	0x69, 0x73, 0x74, 0x42, 0x22, 0x0a, 0x0a, 0x61, 0x70, 0x69, 0x2e, 0x61, 0x70, 0x70, 0x2e, 0x76,
...
var file_api_app_v1_app_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_api_app_v1_app_proto_goTypes = []interface{}{
	...
	(*EthAuthorizeRequest_SendBody)(nil),  // 18: api.app.v1.EthAuthorizeRequest.SendBody
	(*UserRecommendReply_List)(nil),       // 19: api.app.v1.UserRecommendReply.List
	(*UserRecommendLReply_List)(nil),      // 20: api.app.v1.UserRecommendLReply.List
	(*UserLandReply_List)(nil),            // 21: api.app.v1.UserLandReply.List
	(*UserStakeRewardListReply_List)(nil), // 22: api.app.v1.UserStakeRewardListReply.List
	(*UserBoxListReply_List)(nil),         // 23: api.app.v1.UserBoxListReply.List
	(*UserBackListReply_List)(nil),        // 24: api.app.v1.UserBackListReply.List
}
var file_api_app_v1_app_proto_depIdxs = []int32{
	18, // 0: api.app.v1.EthAuthorizeRequest.send_body:type_name -> api.app.v1.EthAuthorizeRequest.SendBody
	19, // 1: api.app.v1.UserRecommendReply.list:type_name -> api.app.v1.UserRecommendReply.List
	20, // 2: api.app.v1.UserRecommendLReply.list:type_name -> api.app.v1.UserRecommendLReply.List
	21, // 3: api.app.v1.UserLandReply.list:type_name -> api.app.v1.UserLandReply.List
	22, // 4: api.app.v1.UserStakeRewardListReply.list:type_name -> api.app.v1.UserStakeRewardListReply.List
	23, // 5: api.app.v1.UserBoxListReply.list:type_name -> api.app.v1.UserBoxListReply.List
	24, // 6: api.app.v1.UserBackListReply.list:type_name -> api.app.v1.UserBackListReply.List
	0,  // 7: api.app.v1.App.TestSign:input_type -> api.app.v1.TestSignRequest
	2,  // 8: api.app.v1.App.EthAuthorize:input_type -> api.app.v1.EthAuthorizeRequest
	4,  // 9: api.app.v1.App.UserInfo:input_type -> api.app.v1.UserInfoRequest
	6,  // 10: api.app.v1.App.UserRecommend:input_type -> api.app.v1.UserRecommendRequest
	8,  // 11: api.app.v1.App.UserRecommendL:input_type -> api.app.v1.UserRecommendLRequest
	10, // 12: api.app.v1.App.UserLand:input_type -> api.app.v1.UserLandRequest
	12, // 13: api.app.v1.App.UserStakeRewardList:input_type -> api.app.v1.UserStakeRewardListRequest
	14, // 14: api.app.v1.App.UserBoxList:input_type -> api.app.v1.UserBoxListRequest
	16, // 15: api.app.v1.App.UserBackList:input_type -> api.app.v1.UserBackListRequest
	1,  // 16: api.app.v1.App.TestSign:output_type -> api.app.v1.TestSignReply
	3,  // 17: api.app.v1.App.EthAuthorize:output_type -> api.app.v1.EthAuthorizeReply
	5,  // 18: api.app.v1.App.UserInfo:output_type -> api.app.v1.UserInfoReply
	7,  // 19: api.app.v1.App.UserRecommend:output_type -> api.app.v1.UserRecommendReply
	9,  // 20: api.app.v1.App.UserRecommendL:output_type -> api.app.v1.UserRecommendLReply
	11, // 21: api.app.v1.App.UserLand:output_type -> api.app.v1.UserLandReply
	13, // 22: api.app.v1.App.UserStakeRewardList:output_type -> api.app.v1.UserStakeRewardListReply
	15, // 23: api.app.v1.App.UserBoxList:output_type -> api.app.v1.UserBoxListReply
	17, // 24: api.app.v1.App.UserBackList:output_type -> api.app.v1.UserBackListReply
